...
**Status:** Chemistry up to Grade 8 is complete (6 units). **Physics** up to Grade 8 is complete (7 units): Measurement & Motion; Forces & Pressure; Energy, Heat & Temperature; Light; Sound; Electricity & Magnetism; Earth & Space. See [docs/curriculum/physics.md](docs/curriculum/physics.md). **Biology** up to Grade 8 is complete (8 units): Living Things & Classification; Cells; Microorganisms; Nutrition; Human Body Systems; Health & Disease; Reproduction & Adolescence; Ecosystems & Conservation; see [docs/curriculum/biology.md](docs/curriculum/biology.md). **Mathematics** is in progress: Units 1–8 (Integers, Fractions & Rational Numbers; Squares, Cubes & Roots; Powers & Exponents; Algebra: Expressions & Identities; Linear Equations & Graphs; Ratio, Proportion & Percentages; Geometry; Mensuration) are built; see [docs/curriculum/mathematics.md](docs/curriculum/mathematics.md). Subjects appear in the order Physics, Chemistry, Biology, Mathematics.
