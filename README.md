...
**Status:** Chemistry up to Grade 8 is complete (6 units). **Physics** is in progress: Unit 1 (Measurement & Motion) is built, with Units 2–7 planned in [docs/curriculum/physics.md](docs/curriculum/physics.md).
...
| 4 | [docs/curriculum/physics.md](docs/curriculum/physics.md) | Physics topic map (Unit 1 built) |
